...
/// </summary>
internal sealed class GenerateProductsSettings : GenerateSettings, IConnectionConfiguration, IItemSettings<Product>
{
    /// <summary>
    /// Optional.
    ...
    public string ContainerName { get; init; } = "products";
    ...
    public override ValidationResult Validate()
    {
        return (Endpoint, ConnectionString, Emulator, Quantity) switch
        {
            ...
            (_, _, _, > ProductsDataSource.MaxProductsCount) => ValidationResult.Error($"The quantity must be less than {ProductsDataSource.MaxProductsCount + 1:N0}."),
